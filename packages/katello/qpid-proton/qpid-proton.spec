...
%global upstream_commit 745c9a01d19ec51bbd607059ef58f9b1a4defad2
%global upstream_version 0.33.0
%global spec_version %(c=%{upstream_version}; echo ${c:0:6})
#%global spec_release 22
#%global spec_release %(c=%{upstream_commit}; echo $(date +"%Y%m%d").${c:0:6})
%global spec_release 6
...
Source0:        amq-clients-745c9a01d19ec51bbd607059ef58f9b1a4defad2.tar.gz
Patch0:         proton.patch
...
%setup -q -n amq-clients-%{upstream_commit}
%patch0 -p1
...
%changelog
* Tue Dec 15 2020 Irina Boverman <iboverma@redhat.com> - 0.33.0-6
- Resolved PROTON-1516, PROTON-1914, PROTON-2172, PROTON-2309
- Resolved ENTMQCL-2332, ENTMQCL-2521

* Wed Nov 18 2020 Irina Boverman <iboverma@redhat.com> - 0.33.0-3
- Changed compiler flags

* Wed Nov 18 2020 Irina Boverman <iboverma@redhat.com> - 0.33.0-2
- Changed how cproton.so is installed

* Mon Nov 16 2020 Irina Boverman <iboverma@redhat.com> - 0.33.0-1
- Rebased to 0.33.0 rc2 upstream

* Thu Aug 20 2020 Irina Boverman <iboverma@redhat.com> - 0.32.0-2
- Added rubygem-qpid_proton package
- Rebased to 0.32.0 rc1 upstream

* Fri May 29 2020 Irina Boverman <iboverma@redhat.com> - 0.31.0-3
- Resolved PROTON-2228

* Fri May 15 2020 Irina Boverman <iboverma@redhat.com> - 0.31.0-2
- Rebased to 0.31.0 upstream

* Wed Jan 22 2020 Irina Boverman <iboverma@redhat.com> - 0.30.0-3
- Rebased to 0.30.0 upstream
- Resolved ENTMQCL-1271

* Tue Dec  3 2019 Irina Boverman <iboverma@redhat.com> - 0.29.0-4
- Resolved ENTMQCL-1820

* Tue Nov 26 2019 Irina Boverman <iboverma@redhat.com> - 0.29.0-3
- Resolved ENTMQCL-1790/PROTON-2116,PROTON-2140,PROTON-2146

* Thu Aug 29 2019 Irina Boverman <iboverma@redhat.com> - 0.29.0-2
- Resolved ENTMQCL-1282/PROTON-2092

* Wed Aug 14 2019 Irina Boverman <iboverma@redhat.com> - 0.29.0-1
